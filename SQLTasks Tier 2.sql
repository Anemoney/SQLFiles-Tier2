...
SELECT 
CASE WHEN monthlymaintenance > 100 THEN CONCAT_WS(' - ', name, 'expensive')
ELSE CONCAT_WS(' - ', name, 'cheap') END as facility,
monthlymaintenance
FROM Facilities;


/* Q6: You'd like to get the first and last name of the last member(s)
who signed up. Try not to use the LIMIT clause for your solution. No idea how to limit results without LIMIT on MySQL 5.5 */
